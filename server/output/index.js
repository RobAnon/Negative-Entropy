...
function parse$e (src /*: string | Buffer */, options /*: ?DotenvParseOptions */) /*: DotenvParseOutput */ {
...
function config (options /*: ?DotenvConfigOptions */) /*: DotenvConfigOutput */ {
  ...
  try {
    ...
    const parsed = parse$e(fs__default['default'].readFileSync(dotenvPath, { encoding }), { debug });
...
var deprecate = browser$4('http-errors');
...
var http = getCjsExportFromNamespace(_nodeResolve_empty$1);
...
var debug$b = browser$3('body-parser:json');
...
var debug$a = browser$3('body-parser:raw');
...
var debug$9 = browser$3('body-parser:text');
...
var debug$8 = browser$3('body-parser:urlencoded');
...
var debug$6 = browser$2('finalhandler');
...
var debug$4 = browser$1('express:router:layer');
...
var debug$3 = browser$1('express:router:route');
...
var debug$2 = browser$1('express:view');
...
var debug = browser('send');
var deprecate$2 = browser$4('send');
...
function forwarded (req) {
  ...
  var proxyAddrs = parse$1(req.headers['x-forwarded-for'] || '');
...
app.post('/signature', function (req, res) {
  ...
  new web3.eth.Contract(abi, process.env.CONTRACT_ADDRESS, {
    from: account
  });
  var seed = "";
