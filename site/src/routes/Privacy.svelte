...
<section>
    <h1 class="fade-in fade-in-1">Our <b>Privacy</b> Policy</h1>
    <div class="privacy-container fade-in fade-in-2">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Negative Entropy.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Negative Entropy, accessible from <a href="http://negativeentropy.app/" rel="external nofollow noopener" target="_blank">http://negativeentropy.app/</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: NegativeEntropyNFT@gmail.com</li>
        </ul>
    </div>
