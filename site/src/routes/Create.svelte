  ...
  <div class="mint-container">
    ...
    <div class="canvas-container fade-in fade-in-1" id="canvas-container">
      ...
      <div class="button-container">
		<button class="hamburger hamburger--collapse" id="three-hamburger" type="button">	
        ...
        <div class="button-actual" id="inner_div">
			...
			<div class="controls-info">Turn light on/off.</div>
			</button>
	  ...
	  {#if params.seed != null && params.seed != ''} 
			<p id="seed-note">The seed that brought you here was: {params.seed}</p>
		{/if}
    ...
    <div class="mint-buttons fade-in fade-in-1">
	...
	<p class="fade-in fade-in-1" id="please-note">We use the <b><a href="https://github.com/BeyondNFT/sandbox">BeyondNFT iNFT Standard</a></b>. Your NFT will be viewable on any website that has adopted that standard, not just our own.
		<br>
		<br>
		Please note: Due to the complexity of the design and the minting process injecting data directly onto the blockchain, gas prices exceed the typical range and are expected to lie between 0.05 and 0.1 Ξ.
	</p>
